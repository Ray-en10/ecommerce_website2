...
const AddaccUrl = "http://localhost/php-react/login-php/add/addacc.php";
...
function Addacc() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(AddaccUrl, {
      ...
      body: JSON.stringify({ id, reference, name, description, imageurl, amount, price }),
    })
  ...
  return (
    <div>
      ...
      <form className="formProdadd" id="form2" onSubmit={handleSubmit}>
        <h2 className="form__title">ADD ACCESSORIES</h2>
        <input
          type="number"
          placeholder="ID"
          className="input"
